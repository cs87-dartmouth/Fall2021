...
public:
    ...
    static SharedT find(const nlohmann::json &jp, const std::string &key)
    {
        ...
        if (it == jp.end())
            // return nullptr;
            throw DartsException("Cannot find factory object with key '{}' here:\n{}", key, jp.dump(4));
        ...
        if (j.is_string())
        {
            ...
            if (i != instance_registry().end())
                ...
                throw DartsException("Can't find a factory object with name '{}' here:\n{}", name, jp.dump(4));
        }
        else if (j.is_object())
        {
            ...
            throw DartsException("Type mismatch: Expecting either a medium definition or medium name here:\n{}",
                                 jp.dump(4));
    }
...
/*!
    \file
    \brief Implementation of the scene parser
*/
